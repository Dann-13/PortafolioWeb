    ...
    <div className="py-32 xl:pb-0 bg-primary/30 text-center xl:text-left">
      ...
      <div className="container lg:pt-10 mx-auto h-full flex flex-col items-center xl:flex-row gap-6">
        <div className="flex-1 flex flex-col justify-center">
          ...
          <motion.p variants={fadeIn('right', 0.3)} initial='hidden' animate='show' exit='hidden' className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0">
            Soy un amante de la tecnología desde que era niño, mi curiosidad me ha llevado a sumergirme profundamente en el mundo del desarrollo de software. Durante mis años de estudio en la universidad y en diferentes programas de formación, he adquirido conocimientos sólidos en lenguajes de programación y diseño de software.
          </motion.p>
          {/**Counters */}
          <motion.div variants={fadeIn('right', 0.4)} initial='hidden' animate='show' exit='hidden'>
            <div>
              {/**projects */}
              <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0 flex flex-col items-center justify-center sm:justify-start">
        ...
        {/**Informacion */}
        <motion.div variants={fadeIn('left', 0.4)} initial='hidden' animate='show' exit='hidden' className="flex flex-col w-full xl:max-w-[48%] h:[400px]">
                  ...
                  <div key={item.id} className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-white/60">
                    ...
                    <div className="flex gap-x-4">
                      ...
                      {item.icons?.map((icon, iconIndex) => (
                        <div key={iconIndex} className="text-2xl text-white hover:text-accent">
                          {icon}
                        </div>
                      ))}
                    </div>
